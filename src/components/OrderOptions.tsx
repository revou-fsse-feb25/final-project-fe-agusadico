    ...
    <>
      ...
      <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm mb-6">
        ...
        <div className="flex flex-col space-y-3">
          <div 
            className={`border rounded-md p-4 cursor-pointer ${orderOption === 'guest' ? 'border-red-500 bg-red-50 dark:bg-red-900/20' : 'border-gray-300 dark:border-gray-600 hover:border-red-300'}`}
            onClick={() => onOrderOptionChange('guest')}
          >
            <div className="flex items-center">
              <div className={`w-5 h-5 rounded-full border ${orderOption === 'guest' ? 'border-red-500 bg-red-500' : 'border-gray-400 dark:border-gray-500'} flex items-center justify-center mr-3`}>
                {orderOption === 'guest' && (
                  <div className="w-3 h-3 rounded-full bg-white"></div>
                )}
              </div>
              <div>
                <h3 className="font-medium text-gray-900 dark:text-gray-100">Continue as Guest</h3>
                <p className="text-sm text-gray-500 dark:text-gray-400">Checkout without registration</p>
              </div>
            </div>
          </div>
          
          <div 
            className={`border rounded-md p-4 cursor-pointer ${orderOption === 'form' ? 'border-red-500 bg-red-50 dark:bg-red-900/20' : 'border-gray-300 dark:border-gray-600 hover:border-red-300'}`}
            onClick={() => onOrderOptionChange('form')}
          >
            <div className="flex items-center">
              <div className={`w-5 h-5 rounded-full border ${orderOption === 'form' ? 'border-red-500 bg-red-500' : 'border-gray-400 dark:border-gray-500'} flex items-center justify-center mr-3`}>
                {orderOption === 'form' && (
                  <div className="w-3 h-3 rounded-full bg-white"></div>
                )}
              </div>
              <div>
                <h3 className="font-medium text-gray-900 dark:text-gray-100">Register New Member</h3>
                <p className="text-sm text-gray-500 dark:text-gray-400">Provide your details for this order</p>
              </div>
            </div>
          </div>
          
          <div 
            className={`border rounded-md p-4 cursor-pointer ${orderOption === 'login' ? 'border-red-500 bg-red-50 dark:bg-red-900/20' : 'border-gray-300 dark:border-gray-600 hover:border-red-300'}`}
          ...
          <form onSubmit={handleSubmitGuest(onGuestSubmit)}>
            <div className="mb-4">
              ...
              <input 
                ...
                className="w-full border border-gray-300 dark:border-gray-600 rounded-md py-2 px-4 focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100"
